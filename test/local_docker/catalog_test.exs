defmodule LocalDocker.CatalogTest do
  use LocalDocker.DataCase

  alias LocalDocker.Catalog

  describe "products" do
    alias LocalDocker.Catalog.Product

    import LocalDocker.CatalogFixtures
